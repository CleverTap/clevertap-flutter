---
name: version-gather
description: "Detect current CleverTap Flutter SDK versions and fetch latest native SDK versions from GitHub. Use during SDK update workflows or version audits."
...
### Step 4: Calculate New Flutter Version
...
Store as `NEW_FLUTTER_VERSION`.

## Output Format

Return all version data in this exact format:
```
OLD_FLUTTER_VERSION=X.Y.Z
OLD_ANDROID_VERSION=X.Y.Z
OLD_IOS_VERSION=X.Y.Z
NEW_ANDROID_VERSION=X.Y.Z
NEW_IOS_VERSION=X.Y.Z
NEW_FLUTTER_VERSION=X.Y.Z
AUTO_CONFIRM_MODE=true/false
SUMMARY=Current: Flutter vX.Y.Z, Android vX.Y.Z, iOS vX.Y.Z → New: Flutter vX.Y.Z, Android vX.Y.Z, iOS vX.Y.Z
```
...
- [ ] New Flutter version calculated with correct semver bump
